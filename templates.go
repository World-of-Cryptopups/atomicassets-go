...
func (a *AtomicAssets) GetTemplates(options *GetTemplatesQuery) (*TemplatesProps, error) {
	...
	if options != nil {
		...
		u, _ = urljoin.UrlJoin(a.API_URL, TEMPLATES_API, fmt.Sprintf("?%s", v.Encode()))
	} else {
		u, _ = urljoin.UrlJoin(a.API_URL, TEMPLATES_API)
	}
...
func (a *AtomicAssets) GetTemplateID(collectionName string, templateID int) (*TemplateIDProps, error) {
	u, _ := urljoin.UrlJoin(a.API_URL, TEMPLATES_API, collectionName, strconv.Itoa(templateID))
...
func (a *AtomicAssets) GetTemplateIDStats(collectionName string, templateID int) (*TemplateIDStatsProps, error) {
	u, _ := urljoin.UrlJoin(a.API_URL, TEMPLATES_API, collectionName, strconv.Itoa(templateID), "stats")
...
func (a *AtomicAssets) GetTemplateIDLogs(collectionName string, templateID int, options *GetTemplateIDLogs) (*TemplateIDLogsProps, error) {
	...
	u, _ := urljoin.UrlJoin(a.API_URL, SCHEMAS_API, collectionName, strconv.Itoa(templateID), "logs", fmt.Sprintf("?%s", v.Encode()))
